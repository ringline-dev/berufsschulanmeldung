...
$html = "
    ...
    <body>
        <img src='img/logo-ksn.jpg' width='150' />
        <h1>Anmeldung Auszubildende(r) an der Kaufmännischen Schule Stuttgart-Nord</h1>
...
<h2>Ausbildungsberuf/ -betrieb</h2>
    ...
    Bitte unterschreiben Sie dieses maschinell erstellte Dokument und senden Sie es per E-Mail an berufsschulanmeldung@ksn-stuttgart.de oder postalisch an die Adresse der Kaufmännischen Schule Stuttgart-Nord, Heilbronner Str. 155, 70191 Stuttgart.<br><br><br>
    <p>Unterschrift: ____________________________  Firmenstempel: ____________________________ </p>
    Den Unterrichtsbeginn entnehmen Sie bitte ab der KW 36 unter www.ksn-stuttgart.de/termine/berufsschultage.
    </body></html>";
